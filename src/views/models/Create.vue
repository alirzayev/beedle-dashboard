                    ...
                    <div class="card-group mb-0">
                        <div class="card">
                            <div class="card-header">
                                <h4>Add Model</h4>
                                <span class="text-muted">Add new model to {{ $route.params.brand }} brand</span>
                            </div>
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <button type="button" class="btn btn-primary px-4" @click="addModel">Add
    ...
    export default {
      ...
      methods: {
        addModel () {
          ...
          this.formData.append('brand_id', this.$route.query.id)

          ModelServices.create(this.formData)
            .then((response) => {
